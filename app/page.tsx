...
export const metadata: Metadata = {
  ...
  description: "Das erste KI-Tool für die deutsche Roblox-Community. Beschreibe dein Spiel auf Deutsch – Kodwerk schreibt den Code.",
};
    ...
    <main style={{
      ...
      <nav className="nav">
        ...
        <ul className="nav-links">
          ...
          <li><a href="#" className="nav-cta">Kostenlos starten</a></li>
        </ul>
      </nav>
      ...
      <section className="pricing">
        ...
        <div className="pricing-grid">
          <div className="pricing-card">
            ...
            <button className="plan-btn plan-btn-outline">Kostenlos starten</button>
          </div>
          <div className="pricing-card featured">
            ...
            <button className="plan-btn plan-btn-filled">Pro werden</button>
          </div>
        </div>
      </section>
